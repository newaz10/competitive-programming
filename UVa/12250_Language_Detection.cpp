...
int main() {
    ...
    for(int i = 1; ; i++) {
        ...
        if(str == "#") {break;}
        else if(str == "HELLO") {str = "ENGLISH";}
        else if(str == "HOLA") {str = "SPANISH";}
        else if(str == "HALLO") {str = "GERMAN";}
        else if(str == "BONJOUR") {str = "FRENCH";}
        else if(str == "CIAO") {str = "ITALIAN";}
        else if(str == "ZDRAVSTVUJTE") {str = "RUSSIAN";}
        else {str = "UNKNOWN";}
